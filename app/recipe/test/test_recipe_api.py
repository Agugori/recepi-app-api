...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_partial_update(self):
        ...
        orinial_link = 'https://example.com/recipe.pdf'
        ...
        self.assertEqual(recipe.link, orinial_link)
        self.assertEqual(recipe.user, self.user)
    ...
    def update_return_error(self):
        """Test if the update return an error"""
    ...
    def test_delete_other_user_recipe_error(self):
        """Test another users recipe gives error"""
    ...
    def test_create_recipe_with_new_ingredient(self):
        """Test creating a new recipe with new ingredientes"""
        payload = {
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing of the ingredients in a recipe"""
    ...
    def test_filter_by_ingredients(self):
        ...
        recipe3 = create_recipe(user=self.user, title='Red Lentil Dal')
